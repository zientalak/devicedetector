 ...
 */
class ChromiumVisitor extends AbstractPatternVisitor
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if ($match) {
            $collector->setCapability(Capabilities::BROWSER, Capabilities::BROWSER_CHROMIUM)
    ...
    {
        return '#chromium\/(?P<version>[^\s]+)#is';
    }
}
