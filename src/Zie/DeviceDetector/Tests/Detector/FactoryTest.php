...
class FactoryTest extends \PHPUnit_Framework_TestCase
{
    public function testCreateDeviceDetectorFromUserAgent()
    {
        ...
        $this->assertInstanceOf('Zie\DeviceDetector\Detector\DeviceDetector', $detector);
    }
    ...
    public function testCreateCacheDeviceDetectorFromUserAgent()
    {
        ...
        $factory = new Factory();
        $detector = $factory->createCacheDeviceDetectorFromUserAgent($userAgent);

        $this->assertInstanceOf('Zie\DeviceDetector\Detector\CacheDetector', $detector);
    }
}
