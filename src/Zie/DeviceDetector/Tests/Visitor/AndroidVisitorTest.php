...
class AndroidVisitorTest extends VisitorTestCase
{
    ...
    public function testFailure()
    {
        ...
        $this->assertNull($context->getCapability(Capabilities::OS));
        $this->assertNull($context->getCapability(Capabilities::OS_VENDOR));
        $this->assertNull($context->getCapability(Capabilities::OS_VERSION));
        $this->assertNull($context->getCapability(Capabilities::OS_RELEASE));
    }
}