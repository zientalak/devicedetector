...
class StriposMatchingStrategySpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType('DeviceDetectorIO\DeviceDetector\MatchingStrategy\StriposMatchingStrategy');
    }
    ...
    function it_accept_only_stripos_rule_strategy()
    {
        $this
            ->match(
